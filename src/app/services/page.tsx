...
export default function Page() {
    return (
        <div className="flex flex-col gap-16 pb-24 px-4 md:px-24 text-primary">
            <section className="flex flex-col gap-4 px-4 md:px-40 py-20 md:py-24 items-center justify-center h-max">
                <h1 className="text-4xl md:text-6xl text-center font-medium text-primary">Your Brand Deserves a Glow-Up!</h1>
                <p className="text-center text-primary md:w-8/12">At Pinn Creative Hub, we don’t just design—we Pinnpoint exactly what makes your brand shine (see what we did there?). Need a logo that slaps? A website that doesn’t make people rage-quit? We’ve got you. Let’s make your brand unforgettable</p>
            </section>
